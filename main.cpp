...
public:
    ...
    bool Load(ReloadDesc *pReloadDesc) override
    {
        ...
        DemoScene.Load(pReloadDesc, pRenderer, pSwapChain->ppRenderTargets[0], pDepthBuffer, gImageCount);
        return true;
    }
    ...
    void Unload(ReloadDesc *pReloadDesc) override
    {
        ...
        DemoScene.Unload(pReloadDesc, pRenderer);
    ...
    void Update(float deltaTime) override
    {
        ...
        DemoScene.Update(deltaTime, mSettings.mWidth, mSettings.mHeight);
    }
    ...
    void Draw() override
    {
        ...
        DemoScene.Draw(cmd, pRenderTarget, pDepthBuffer, gFrameIndex);
